...
public class QuizActivity extends AppCompatActivity {
	...
	public static final String EXTRA_QUIZ_QUESTION = "itp341.geoquiz.EXTRA_QUIZ_QUESTION";
...
//		answers = getResources().getIntArray(R.array.array_answers);
		...
		int[] tempAnswers = getResources().getIntArray(R.array.array_answers);
		...
		buttonCheat.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// but what if we want to pass an object to another activity??
	...
	private void checkAnswer(boolean userPressedTrue) {
		...
		// boolean answerIsTrue = (answers[currentIndex] == 1);
		boolean answerIsTrue = (questions[currentIndex].isAnswer() == true);
		int messageResId = 0;
	...
	private void saveScore() {
		...
		// comitt or save the changes
		editor.commit();

	}

	// ON RESET -> Set variables to 0 and write 0's to the shared preferences
